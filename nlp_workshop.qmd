...
set.seed(42) ### so we always get the same sample
refs_df <- refs_df_raw %>%
...
Arun and Griffiths indices recommend 40 (or more!) topics based on strict minimization/maximization, though the marginal improvement tapers off after the first five or ten.  The Deveaud index looks like it recommends eight or nine topics, which seems better for a coarse understanding.  The CaoJuan index  drops sharply to about eight topics, then levels off.  Based on these, let's choose eight topics.



## Running LDA on the full subset

Now we can run our LDA and get some results!  This might take a little while...

```{r}
abstr_lda <- topicmodels::LDA(abstr_dtm, k = 8)
```
...
* Topic 1: Ecological Impact and Management
* Topic 2: Land Use and Grazing
* Topic 3: Water Resource and Climate Change
* Topic 4: Social System and Governance
* Topic 5: Community Resilience and Governance
* Topic 6: Dynamic Ecosystem Modeling
* Topic 7: Fishery Management and Conservation
* Topic 8: Human-Environment Interaction and Fire Ecology
...
```{r}
topic_names <- c(topic1 = 'Ecological Impact and Management',
                 topic2 = 'Land Use and Grazing',
                 topic3 = 'Water Resource and Climate Change',
                 topic4 = 'Social System and Governance',
                 topic5 = 'Community Resilience and Governance',
                 topic6 = 'Dynamic Ecosystem Modeling',
                 topic7 = 'Fishery Management and Conservation',
                 topic8 = 'Human-Environment Interaction and Fire Ecology')

doc_topics <- abstr_topics %>%
